...
extern TFLGpuDelegateOptions TFLGpuDelegateOptionsDefault(void);
...
// .wait_type = kPassive,
extern TfLiteDelegate* TFLGpuDelegateCreate(
    const TFLGpuDelegateOptions* options);

// Destroys a delegate created with `TFLGpuDelegateCreate` call.
extern void TFLGpuDelegateDelete(TfLiteDelegate* delegate);
...
extern bool TFLGpuDelegateBindMetalBufferToTensor(
